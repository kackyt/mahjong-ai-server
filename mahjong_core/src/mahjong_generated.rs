...
pub mod open_mahjong {
    ...
    impl MentsuType {
        ...
        pub const TYPE_KOKUSHI: Self = Self(5);
        ...
        pub fn variant_name(self) -> Option<&'static str> {
            match self {
                ...
                Self::TYPE_KOKUSHI => Some("TYPE_KOKUSHI"),
                _ => None,
            }
        }
    }
    ...
    impl<'a> ::flatbuffers::Follow<'a> for FixedString {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { <&'a FixedString>::follow(buf, loc) }
        }
    }
    impl<'a> ::flatbuffers::Follow<'a> for &'a FixedString {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { ::flatbuffers::follow_cast_ref::<FixedString>(buf, loc) }
        }
    }
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src = unsafe {
                ::core::slice::from_raw_parts(
                    self as *const FixedString as *const u8,
    ...
    impl FixedStringT {
        pub fn pack(&self) -> FixedString {
            FixedString::new(
                &self.n1, &self.n2, &self.n3, &self.n4, &self.n5, &self.n6, &self.n7, &self.n8,
            )
        }
    }
    ...
    impl<'a> ::flatbuffers::Follow<'a> for &'a Pai {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { ::flatbuffers::follow_cast_ref::<Pai>(buf, loc) }
        }
    }
    ...
    impl<'a> ::flatbuffers::Follow<'a> for &'a Taku {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { ::flatbuffers::follow_cast_ref::<Taku>(buf, loc) }
        }
    }
    impl<'b> ::flatbuffers::Push for Taku {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src = unsafe {
                ::core::slice::from_raw_parts(
                    self as *const Taku as *const u8,
                    <Self as ::flatbuffers::Push>::size(),
                )
            };
            dst.copy_from_slice(src);
    ...
    impl<'a> Taku {
        ...
        pub fn set_n1(&mut self, x: &[Pai; 32]) {
            ...
            // Which contains a valid array in this slot
            unsafe {
                ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(0), 160);
            }
        }
        ...
        pub fn set_n2(&mut self, x: &[Pai; 32]) {
            ...
            // Which contains a valid array in this slot
            unsafe {
                ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(160), 160);
            }
        }
        ...
        pub fn set_n3(&mut self, x: &[Pai; 32]) {
            ...
            // Which contains a valid array in this slot
            unsafe {
                ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(320), 160);
            }
        }
        ...
        pub fn set_n4(&mut self, x: &[Pai; 32]) {
            ...
            // Which contains a valid array in this slot
            unsafe {
                ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(480), 160);
            }
        }
        ...
        pub fn set_n5(&mut self, x: &[Pai; 8]) {
            ...
            // Which contains a valid array in this slot
            unsafe {
                ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(640), 40);
            }
        }
        ...
        pub fn unpack(&self) -> TakuT {
            TakuT {
                n1: {
                    let n1 = self.n1();
                    ::flatbuffers::array_init(|i| n1.get(i).unpack())
                },
                n2: {
                    let n2 = self.n2();
                    ::flatbuffers::array_init(|i| n2.get(i).unpack())
                },
                n3: {
                    let n3 = self.n3();
                    ::flatbuffers::array_init(|i| n3.get(i).unpack())
                },
                n4: {
                    let n4 = self.n4();
                    ::flatbuffers::array_init(|i| n4.get(i).unpack())
                },
                n5: {
                    let n5 = self.n5();
                    ::flatbuffers::array_init(|i| n5.get(i).unpack())
                },
                length: self.length(),
            }
        }
    ...
    impl<'a> ::flatbuffers::Follow<'a> for MentsuPai {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { <&'a MentsuPai>::follow(buf, loc) }
        }
    }
    impl<'a> ::flatbuffers::Follow<'a> for &'a MentsuPai {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { ::flatbuffers::follow_cast_ref::<MentsuPai>(buf, loc) }
        }
    }
    impl<'b> ::flatbuffers::Push for MentsuPai {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src = unsafe {
                ::core::slice::from_raw_parts(
                    self as *const MentsuPai as *const u8,
                    <Self as ::flatbuffers::Push>::size(),
                )
            };
            dst.copy_from_slice(src);
    ...
    impl<'a> MentsuPai {
        #[allow(clippy::too_many_arguments)]
        pub fn new(pai_num: u8, id: u8, flag: MentsuFlag) -> Self {
            let mut s = Self([0; 3]);
            s.set_pai_num(pai_num);
            s.set_id(id);
            s.set_flag(flag);
        ...
        pub fn flag(&self) -> MentsuFlag {
            let mut mem = ::core::mem::MaybeUninit::<
                <MentsuFlag as ::flatbuffers::EndianScalar>::Scalar,
            >::uninit();
            // Safety:
            // Created from a valid Table for this object
            // Which contains a valid value in this slot
            ::flatbuffers::EndianScalar::from_little_endian(unsafe {
                ::core::ptr::copy_nonoverlapping(
                    self.0[2..].as_ptr(),
                    mem.as_mut_ptr() as *mut u8,
                    ::core::mem::size_of::<<MentsuFlag as ::flatbuffers::EndianScalar>::Scalar>(),
                );
                mem.assume_init()
            })
        }
    ...
    impl MentsuPaiT {
        pub fn pack(&self) -> MentsuPai {
            MentsuPai::new(self.pai_num, self.id, self.flag)
        }
    }
    ...
    impl<'a> ::flatbuffers::Follow<'a> for Mentsu {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { <&'a Mentsu>::follow(buf, loc) }
        }
    }
    impl<'a> ::flatbuffers::Follow<'a> for &'a Mentsu {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { ::flatbuffers::follow_cast_ref::<Mentsu>(buf, loc) }
        }
    }
    impl<'b> ::flatbuffers::Push for Mentsu {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src = unsafe {
                ::core::slice::from_raw_parts(
                    self as *const Mentsu as *const u8,
                    <Self as ::flatbuffers::Push>::size(),
                )
            };
            dst.copy_from_slice(src);
    ...
    impl<'a> Mentsu {
        #[allow(clippy::too_many_arguments)]
        pub fn new(pai_list: &[MentsuPai; 4], pai_len: u32, mentsu_type: MentsuType) -> Self {
            let mut s = Self([0; 20]);
        ...
        pub fn set_pai_list(&mut self, x: &[MentsuPai; 4]) {
            ...
            // Which contains a valid array in this slot
            unsafe {
                ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(0), 12);
            }
        }
        ...
        pub fn mentsu_type(&self) -> MentsuType {
            let mut mem = ::core::mem::MaybeUninit::<
                <MentsuType as ::flatbuffers::EndianScalar>::Scalar,
            >::uninit();
            // Safety:
            // Created from a valid Table for this object
            // Which contains a valid value in this slot
            ::flatbuffers::EndianScalar::from_little_endian(unsafe {
                ::core::ptr::copy_nonoverlapping(
                    self.0[16..].as_ptr(),
                    mem.as_mut_ptr() as *mut u8,
                    ::core::mem::size_of::<<MentsuType as ::flatbuffers::EndianScalar>::Scalar>(),
                );
                mem.assume_init()
            })
        }
        ...
        pub fn unpack(&self) -> MentsuT {
            MentsuT {
                pai_list: {
                    let pai_list = self.pai_list();
                    ::flatbuffers::array_init(|i| pai_list.get(i).unpack())
                },
    ...
    impl<'a> ::flatbuffers::Follow<'a> for Player {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { <&'a Player>::follow(buf, loc) }
        }
    }
    impl<'a> ::flatbuffers::Follow<'a> for &'a Player {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { ::flatbuffers::follow_cast_ref::<Player>(buf, loc) }
        }
    }
    impl<'b> ::flatbuffers::Push for Player {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src = unsafe {
                ::core::slice::from_raw_parts(
                    self as *const Player as *const u8,
                    <Self as ::flatbuffers::Push>::size(),
                )
            };
            dst.copy_from_slice(src);
    ...
    impl<'a> Player {
        ...
        pub fn set_mentsu(&mut self, x: &[Mentsu; 4]) {
            ...
            // Which contains a valid array in this slot
            unsafe {
                ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(256), 80);
            }
        }
        ...
        pub fn set_tehai(&mut self, x: &[Pai; 13]) {
            ...
            // Which contains a valid array in this slot
            unsafe {
                ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(340), 65);
            }
        }
        ...
        pub fn set_kawahai(&mut self, x: &[Pai; 20]) {
            ...
            // Which contains a valid array in this slot
            unsafe {
                ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(412), 100);
            }
        }
        ...
        pub fn unpack(&self) -> PlayerT {
            PlayerT {
                ...
                mentsu: {
                    let mentsu = self.mentsu();
                    ::flatbuffers::array_init(|i| mentsu.get(i).unpack())
                },
                mentsu_len: self.mentsu_len(),
                tehai: {
                    let tehai = self.tehai();
                    ::flatbuffers::array_init(|i| tehai.get(i).unpack())
                },
                tehai_len: self.tehai_len(),
                kawahai: {
                    let kawahai = self.kawahai();
                    ::flatbuffers::array_init(|i| kawahai.get(i).unpack())
                },
    ...
    impl ::core::fmt::Debug for Rule {
        fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
            f.debug_struct("Rule")
                ...
                .field("enable_atozuke", &self.enable_atozuke())
                ...
                .field("enable_glass_pai", &self.enable_glass_pai())
    ...
    impl<'a> ::flatbuffers::Follow<'a> for &'a Rule {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { ::flatbuffers::follow_cast_ref::<Rule>(buf, loc) }
        }
    }
    impl<'b> ::flatbuffers::Push for Rule {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src = unsafe {
                ::core::slice::from_raw_parts(
                    self as *const Rule as *const u8,
                    <Self as ::flatbuffers::Push>::size(),
                )
            };
            dst.copy_from_slice(src);
    ...
    impl<'a> Rule {
        ...
        pub fn new(
            ...
            s.set_enable_atozuke(enable_atozuke);
            ...
            s.set_enable_glass_pai(enable_glass_pai);
        ...
        pub fn enable_atozuke(&self) -> bool {
            let mut mem =
                ::core::mem::MaybeUninit::<<bool as ::flatbuffers::EndianScalar>::Scalar>::uninit();
            // Safety:
            // Created from a valid Table for this object
        ...
        pub fn set_enable_atozuke(&mut self, x: bool) {
            let x_le = ::flatbuffers::EndianScalar::to_little_endian(x);
            // Safety:
            // Created from a valid Table for this object
            // Which contains a valid value in this slot
        ...
        pub fn enable_glass_pai(&self) -> bool {
            let mut mem =
                ::core::mem::MaybeUninit::<<bool as ::flatbuffers::EndianScalar>::Scalar>::uninit();
            // Safety:
            // Created from a valid Table for this object
        ...
        pub fn set_enable_glass_pai(&mut self, x: bool) {
            let x_le = ::flatbuffers::EndianScalar::to_little_endian(x);
            // Safety:
            // Created from a valid Table for this object
            // Which contains a valid value in this slot
        ...
        pub fn unpack(&self) -> RuleT {
            RuleT {
                ...
                enable_atozuke: self.enable_atozuke(),
                ...
                enable_glass_pai: self.enable_glass_pai(),
    ...
    #[repr(transparent)]
    #[derive(Clone, Copy, PartialEq)]
    pub struct GameState(pub [u8; 3192]);
    ...
    impl<'a> ::flatbuffers::Follow<'a> for GameState {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { <&'a GameState>::follow(buf, loc) }
        }
    }
    impl<'a> ::flatbuffers::Follow<'a> for &'a GameState {
        ...
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            unsafe { ::flatbuffers::follow_cast_ref::<GameState>(buf, loc) }
        }
    }
    impl<'b> ::flatbuffers::Push for GameState {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src = unsafe {
                ::core::slice::from_raw_parts(
                    self as *const GameState as *const u8,
                    <Self as ::flatbuffers::Push>::size(),
                )
            };
            dst.copy_from_slice(src);
    ...
    impl<'a> GameState {
        ...
        pub fn set_players(&mut self, x: &[Player; 4]) {
            ...
            // Which contains a valid array in this slot
            unsafe {
                ::core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(280), 2128);
            }
        }
        ...
        pub fn set_rule(&mut self, x: &Rule) {
            self.0[3136..3136 + 52].copy_from_slice(&x.0)
        }
        ...
        pub fn unpack(&self) -> GameStateT {
            GameStateT {
                ...
                players: {
                    ...
                    ::flatbuffers::array_init(|i| players.get(i).unpack())
                },
