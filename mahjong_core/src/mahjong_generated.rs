...
pub mod open_mahjong {
    ...
    impl<'b> flatbuffers::Push for MentsuPai {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src =
                ::core::slice::from_raw_parts(self as *const MentsuPai as *const u8, Self::size());
            dst.copy_from_slice(src);
        }
    }
    ...
    impl<'b> flatbuffers::Push for Mentsu {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src =
                ::core::slice::from_raw_parts(self as *const Mentsu as *const u8, Self::size());
            dst.copy_from_slice(src);
        }
    }
    ...
    impl<'b> flatbuffers::Push for Player {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src =
                ::core::slice::from_raw_parts(self as *const Player as *const u8, Self::size());
            dst.copy_from_slice(src);
        }
    }
    ...
    impl<'b> flatbuffers::Push for GameState {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src =
                ::core::slice::from_raw_parts(self as *const GameState as *const u8, Self::size());
            dst.copy_from_slice(src);
        }
    }
